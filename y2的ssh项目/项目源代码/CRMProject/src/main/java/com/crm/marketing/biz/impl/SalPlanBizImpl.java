...
public class SalPlanBizImpl implements SalPlanBiz{
	...
	@Override
	public int delPlan(Map<String, String[]> paMap) throws NoSuchFieldException, SecurityException,
			IllegalArgumentException, IllegalAccessException, SQLException {
		return planDao.delPlan(paMap);
	}

	@Override
	public int editState(Map<String, String[]> paMap) throws NoSuchFieldException, SecurityException,
			IllegalArgumentException, IllegalAccessException, SQLException {
		// TODO Auto-generated method stub
		return planDao.editState(paMap);
	}
